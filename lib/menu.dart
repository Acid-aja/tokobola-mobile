...
import 'package:tokobola/product_form.dart';
import 'package:tokobola/widgets/left_drawer.dart';

class MyHomePage extends StatelessWidget {
  const MyHomePage({super.key});

  final String nama = "Izzudin Abdul Rasyid"; //nama
  final String npm = "2406495786"; //npm
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "TokoBola" dengan teks putih dan tebal.
        title: const Text(
          'TokoBola',
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: () {
          ...
          // mengarahkan tombol create product ke productformpage
